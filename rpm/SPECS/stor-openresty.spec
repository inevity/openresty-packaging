...
BuildRequires:  stor-zlib-devel >= 1.2.8-1
BuildRequires:  stor-openssl-devel >= 1.0.2j-1
BuildRequires:  stor-pcre-devel >= 8.39-3
BuildRequires:  GeoIP-devel
Requires:       stor-zlib >= 1.2.8-1
Requires:       stor-openssl >= 1.0.2h-5
Requires:       stor-pcre >= 8.39-3
Requires:       GeoIP
Requires:       stor-iconv >= 1.15 
...
%define iconv_prefix        %{orprefix}/iconv
...
./configure \
    ...
    --with-ld-opt="-L%{zlib_prefix}/lib -L%{pcre_prefix}/lib -L%{openssl_prefix}/lib -L%{iconv_prefix}/lib \
    -Wl,-rpath,%{zlib_prefix}/lib:%{pcre_prefix}/lib:%{openssl_prefix}/lib:%{iconv_prefix}/lib" \
    --with-pcre-jit \
    ...
    --add-module=bundle/ngx_http_url_gbk_module/mod_handler/url_gbk \
    %{?_smp_mflags}
...
rm -f %{buildroot}%{orprefix}/nginx/conf/nginx.conf
