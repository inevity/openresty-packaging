...
BuildRequires:      stor-zlib-devel >= 1.2.8
Requires:           stor-zlib >= 1.2.8

AutoReqProv:        no

%define openssl_prefix      /usr/local/stor-openresty/openssl
%define zlib_prefix         /usr/local/stor-openresty/zlib
